...
export default function BookingsPage() {
  ...
  return (
    <div className="p-4 md:p-8">
      <div className="mb-6">
        <h1 className="text-lg font-semibold text-gray-900">Записи на занятия</h1>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 bg-gray-50 text-left">
                ...
                <th className="px-4 py-3 font-medium text-gray-600">Занятие</th>
                <th className="px-4 py-3 font-medium text-gray-600">Дата занятия</th>
              ...
              {rows.map((row) => (
                <tr key={row.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 text-gray-700 max-w-[160px]">
                    <span className="block truncate">{row.service_title}</span>
                  </td>
                  <td className="px-4 py-3 text-gray-500 whitespace-nowrap">{fmtDatetime(row.start_datetime)}</td>
                  <td className="px-4 py-3 text-gray-400 whitespace-nowrap text-xs">{fmtDatetime(row.created_at)}</td>
